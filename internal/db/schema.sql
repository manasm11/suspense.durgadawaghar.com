...
CREATE TABLE identifiers (
    ...
    type TEXT NOT NULL CHECK (type IN ('upi_vpa', 'phone', 'account_number', 'ifsc', 'imps_name', 'bank_name', 'neft_name', 'cash_bank_code', 'cash_location', 'cash_agent_code', 'from_account', 'from_name')),
    value TEXT NOT NULL,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    UNIQUE(type, value)
);
